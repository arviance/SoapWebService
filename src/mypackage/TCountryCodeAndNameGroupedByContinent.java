...
public class TCountryCodeAndNameGroupedByContinent  implements java.io.Serializable {
    private mypackage.TContinent continent;

    private mypackage.TCountryCodeAndName[] countryCodeAndNames;

    public TCountryCodeAndNameGroupedByContinent() {
    }

    public TCountryCodeAndNameGroupedByContinent(
           mypackage.TContinent continent,
           mypackage.TCountryCodeAndName[] countryCodeAndNames) {
     ...
     * @return continent
     */
    public mypackage.TContinent getContinent() {
        return continent;
    }
     ...
     * @param continent
     */
    public void setContinent(mypackage.TContinent continent) {
        this.continent = continent;
    }
     ...
     */
    public mypackage.TCountryCodeAndName[] getCountryCodeAndNames() {
        return countryCodeAndNames;
    }
     ...
     */
    public void setCountryCodeAndNames(mypackage.TCountryCodeAndName[] countryCodeAndNames) {
        this.countryCodeAndNames = countryCodeAndNames;
    }
