...
public class TCountryInfo  implements java.io.Serializable {
    ...
    private mypackage.TLanguage[] languages;
     ...
     * @return languages
     */
    public mypackage.TLanguage[] getLanguages() {
        return languages;
    }
     ...
     * @param languages
     */
    public void setLanguages(mypackage.TLanguage[] languages) {
        this.languages = languages;
    }
