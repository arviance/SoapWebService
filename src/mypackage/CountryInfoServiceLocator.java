...
public class CountryInfoServiceLocator extends org.apache.axis.client.Service implements mypackage.CountryInfoService {
 ...
 */
    ...
    public mypackage.CountryInfoServiceSoapType getCountryInfoServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.CountryInfoServiceSoapBinding12Stub _stub = new mypackage.CountryInfoServiceSoapBinding12Stub(portAddress, this);
    ...
    public mypackage.CountryInfoServiceSoapType getCountryInfoServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.CountryInfoServiceSoapBindingStub _stub = new mypackage.CountryInfoServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.CountryInfoServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.CountryInfoServiceSoapBinding12Stub _stub = new mypackage.CountryInfoServiceSoapBinding12Stub(new java.net.URL(CountryInfoServiceSoap12_address), this);
                _stub.setPortName(getCountryInfoServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (mypackage.CountryInfoServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.CountryInfoServiceSoapBindingStub _stub = new mypackage.CountryInfoServiceSoapBindingStub(new java.net.URL(CountryInfoServiceSoap_address), this);
                _stub.setPortName(getCountryInfoServiceSoapWSDDServiceName());
                return _stub;
            }
        }
